                            ...
                            <div class="row align-items-center">
                                <div class="col-md-5">
                                    <div class="product-slider-single normal-slider">
                                        <img src="{{Handel_image::show_image($product->image)}}" alt="Product Image">
                                    ...
                                    <div class="product-slider-single-nav normal-slider">
                                        <div class="slider-nav-img"><img src="{{Handel_image::show_image($product->image)}}" alt="Product Image"></div>
                                ...
                                <div class="col-md-7">
                                    <div class="product-content">
                                        ...
                                        <div class="price">
                                            <h4>Price:</h4>
                                            <p>{{Currency::format($product->price)}} <span>{{Currency::format($product->price)}}</span></p>
                                        </div>
                                        <div class="quantity">
                                            <h4>Quantity:</h4>
                                            <div class="qty">
